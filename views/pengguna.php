                                      ...
                                      <div class="modal-content">
                                        ...
                                        <form action="" method="POST">
                                          <div class="modal-body text-center">
                                            ...
                                            <div class="mb-3">
                                              <label for="nomor_telepon" class="form-label">No. Handphone <small class="text-danger">*</small></label>
                                              <input type="number" name="nomor_telepon" value="<?= $row["nomor_telepon"] ?>" class="form-control text-center" id="nomor_telepon" placeholder="No. Handphone" pattern="[0-9]{4}-[0-9]{4}-[0-9]{4||3}" required>
                                            </div>
                                          </div>
                                          <div class="modal-footer justify-content-center border-top-0">
                                            <input type="hidden" name="id-user" value="<?= $row["id_user"] ?>">
                                            <input type="hidden" name="usernameOld" value="<?= $row["username"] ?>">
                                            <input type="hidden" name="nomor_teleponOld" value="<?= $row["nomor_telepon"] ?>">
            ...
            <div class="modal-content">
              ...
              <form action="" method="post" name="random_form">
                <div class="modal-body text-center">
                  ...
                  <div class="mb-3">
                    <label for="nomor_telepon" class="form-label">No. Handphone <small class="text-danger">*</small></label>
                    <input type="number" name="nomor_telepon" class="form-control text-center" id="nomor_telepon" placeholder="No. Handphone" pattern="[0-9]{4}-[0-9]{4}-[0-9]{4||3}" required>
                  </div>
                  <div class="mb-3">
